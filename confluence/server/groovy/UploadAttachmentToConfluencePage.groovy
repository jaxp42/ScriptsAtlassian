...
if(duplicatedFileList.size() > 0){
    showFileList(duplicatedFileList, "The following files have a duplicated name. Please rename them manually to continue or set AUTO_RENAME to true to rename them automatically.")
}
else{
